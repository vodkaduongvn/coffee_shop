...
Write-Host ' - - - - - - - - - - - - - - - - - - - - - - - - - '
#$AzureRepoName = "coffee_shop"
#$ADOCloneURL = "https://vodkaduongvn0834@dev.azure.com/vodkaduongvn0834/coffee_shop/_git/coffee_shop"
#$GitHubCloneURL = "https://github.com/vodkaduongvn/coffee_shop.git"
